					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
						    	...
						    	<li><a href="experiance.php"><?php echo $experiencia ;?></a></li>
			...
			<div class="row team_box">
				...
				<div class="col-md-3 team1">
				  <a class="popup-with-zoom-anim" href="#small-dialog3"><img src="images/team1.jpg" class="img-responsive" title="continue" alt=""/></a>
					...
					<h4 class="m_5"><a href="#"><?php echo $personas[0]?></a></h4>
				...
				<div class="col-md-3 team1">
					...
					<h4 class="m_5"><a href="#"><?php echo $personas[1]?></a></h4>
				    <p class="m_6">sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna</p>
				</div>
				<div class="col-md-3 team1">
					...
					<h4 class="m_5"><a href="#"><?php echo $personas[2]?></a></h4>
				    <p class="m_6">sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna</p>
				</div>
				<div class="col-md-3 team1">
					...
					<h4 class="m_5"><a href="#"><?php echo $personas[3]?></a></h4>
				    <p class="m_6">sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna</p>
				</div>
			</div>
			<div class="row">
