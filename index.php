               ...
               <img src="images/slider1.jpg" class="img-responsive" alt=""/>
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h1 class="title"><?php echo $titulo1?><br><?php echo $titulo2?></h1>
                        <!-- /Text title -->
			...
			<div class="close_but"><i class="close1"> </i></div>
			  <div class="row">
				<div class="col-md-3 top_box">
                  ...
                  <h4 class="m_4"><a href="#"><?php echo $lugar[0]?></a></h4>
                ...
                <div class="col-md-3 top_box">
                   ...
                   <h4 class="m_4"><a href="#"><?php echo $lugar[1]?></a></h4>
                   <p class="m_5">claritatem insitam</p>
				</div>
				<div class="col-md-3 top_box">
					<div class="view view-ninth"><a href="single.html">
                   ...
                   <h4 class="m_4"><a href="#"><?php echo $lugar[2]?></a></h4>
                   <p class="m_5">claritatem insitam</p>
				</div>
				<div class="col-md-3 top_box1">
                   ...
                   <h4 class="m_4"><a href="#"><?php echo $lugar[3]?></a></h4>
                   <p class="m_5">claritatem insitam</p>
				</div>
			</div>
		 </div>
